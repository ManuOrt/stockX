...
/**
        ...
        sneaker.addOffer(new Bid("6", 200));
        sneaker.addOffer(new Bid("9.5", 479));
        sneaker.addOffer(new Bid("13", 338));
        sneaker.addOffer(new Bid("9.5", 480));

        //devolución de la lista de ofertas
...
/**
        ...
        sneaker.addOffer(new Ask("6", 600));
        sneaker.addOffer(new Ask("9.5", 333));
        sneaker.addOffer(new Ask("9.5", 340));
        sneaker.addOffer(new Ask("13", 330));
...
/**
        ...
        sneaker.setBid(maximum.isEmpty()? 0 : maximum.get(0).getValue());
        System.out.println(Stockx.draw(sneaker));
...
/**
        ...
        sneaker.setAsk(minimum.isEmpty()? 0 : minimum.get(0).getValue());
        System.out.println(Stockx.draw(sneaker));
...
/**
        ...
        sneaker.addOffer(sale);
        sneaker.addOffer(new Sale("9.5", 352));
        sneaker.addOffer(new Sale("9.5", 404));
        sneaker.addOffer(new Sale("13", 360));
        sneaker.addOffer(new Sale("13", 372));
...
/**
        ...
        sneaker.setSale(actualSale.isEmpty()? 0 : actualSale.get(0).getValue());
        System.out.println(Stockx.draw(sneaker));
...
/**
       ...
       /*
        ...
        sneaker.setSale(sizeSales.isEmpty()?
                0 :
                sizeSales.get(sizeSales.size() -1).getValue());
...
/**
        ...
        sneaker.setBid(sizeBid.isEmpty()? 0 : sizeBid.get(0).getValue());
        ...
        sneaker.setAsk(sizeAsk.isEmpty()? 0 : sizeAsk.get(0).getValue());
